...
enum eState
{
  ...
  xdx,
  odx
}; //out sinistra, extreme sinistra, sinistra, avanti, destra, extreme destra, out destra
...
void Vai_Sinistra(eState _incisione)
{
  ...
  case sx:
    _iGradazione_dx = 20; //cammina+, curva-
    _iGradazione_sx = 70;
    break;
  }
...
void Vai_Destra(eState _incisione)
{
  ...
  case dx:
    _iGradazione_dx = 135; //cammina+, curva-
    _iGradazione_sx = 120;
    break;
  }
